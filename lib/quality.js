...
export const quality = {
  ...
  // Bruno runs ~78 k blades over a 280×280 m grid (≈1 per m²); scaled
  // to our ≈11 k m² play area at similar density that's ~11 k blades.
  // We push past that because our camera is closer and the player
  // notices individual blades — 30/45/60 k tiers reads as a real
  // meadow rather than scattered tufts.
  grassCount:   TIER === "low" ? 18000 : TIER === "high" ? 60000 : 45000,
